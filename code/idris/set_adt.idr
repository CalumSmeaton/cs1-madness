...
--helper for the helper- return opposite of member

--not_member: (eq a) => a -> list a -> bool
--not_member v l = not (member v l)
...
--all_true: (a -> bool) -> list a -> bool
--all_true p l = not (member (false) (map p l))
...
set_forall p (mkSet l) = not (member (false) (map p l))
...
list_witness p (h :: t) = ite (list_exists p (h::t))
                       (
                         (ite(p h)
                            (some h)
                            (list_witness p t))
...
list_elements: a -> list b -> list (pair a b)
list_elements e nil = nil
list_elements e (h::t) = (mkPair e h) :: (list_elements e t)

list_product: list a -> list b -> list (pair a b)
list_product (ha :: ta) l2 =  (list_elements ha l2) ++ (list_product ta l2)
